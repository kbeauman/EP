...
xmlGlossaryData += '                    <a href=\"javascript:void(0);\" class=\"GlossaryPageTerm\" id=\"MCDropDownHotSpot_3861827558_0\" onclick=\"FMCDropDown( this ); FMCScrollToVisible( window, this.parentNode.parentNode ); return false;\">My Term</a>';
xmlGlossaryData += '                    <a name=\"3861827558_anchor1\">';
xmlGlossaryData += '                    </a>';
xmlGlossaryData += '                </div>';
xmlGlossaryData += '                <div class=\"GlossaryPageDefinition\" id=\"MCDropDownBody_3861827558_0\" style=\"display: none;\">My definition</div>';
xmlGlossaryData += '            </div>';
xmlGlossaryData += '        </div>';
xmlGlossaryData += '        <p>&#160;</p>';
